...
"""
    draw(g::StaticGraph; force = false, inline = false, 
...
"""
function draw(g::StaticGraph; force = false, inline = false, resolution = (1920, 1080),
...
```
"""
function draw(g::Graph; force = false,inline = false, resolution = (1920, 1080),
    nlabels_textsize = 15, arrow_size = 15, node_size = 5)
    draw(g.graph; force = force, inline = inline, resolution = resolution, 
         nlabels_textsize = nlabels_textsize, arrow_size = arrow_size, 
         node_size = node_size)
end
